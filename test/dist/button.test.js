...
exports.default = _default;
        var $b6a078 = exports.default || module.exports;
      
      if (typeof $b6a078 === 'function') {
        $b6a078 = $b6a078.options;
      }
    
        /* template */
        Object.assign($b6a078, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b6a078', $b6a078);
          } else {
            api.reload('$b6a078', $b6a078);
          }
        }
...
var _default = {
  ...
  components: {
    WooIcon: _Icon.default
  },
  methods: {}
};
exports.default = _default;
        var $46b835 = exports.default || module.exports;
      
      if (typeof $46b835 === 'function') {
        $46b835 = $46b835.options;
      }
    
        /* template */
        Object.assign($46b835, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$46b835', $46b835);
          } else {
            api.reload('$46b835', $46b835);
          }
        }
...
_vue.default.config.devtools = false; // BDD 行为驱动测试 Mocha引入

describe("Button组件", function () {
  it("存在", function () {
    // 断言 Chai引入
    expect(_Button.default).to.exist;
  });
  it("可以设置icon", function () {
    var Contructor = _vue.default.extend(_Button.default);

    var testBtn = new Contructor({
      propsData: {
        icon: "woo-icon-download"
      }
    });
    testBtn.$mount();
    var useEl = testBtn.$el.querySelectorAll("use");
    var svgEl = testBtn.$el.querySelectorAll("svg");
    var hrefArr = [];
    useEl.forEach(function (n) {
  ...
  it("默认的order为1", function () {
    ...
    var _window$getComputedSt = window.getComputedStyle(svgEl[0]),
  ...
  it("设置iconPosition可以改变order", function () {
    ...
    var _window$getComputedSt2 = window.getComputedStyle(svgEl[0]),
        order = _window$getComputedSt2.order;
